            ...
            !function (t, n) {
                ...
                var k = function (e) {
                    var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, v, y, m, x, b = "sizzle" + 1 * new Date,
                        w = e.document, T = 0, C = 0, E = ue(), S = ue(), k = ue(), A = ue(), N = function (e, t) {
                            return e === t && (f = !0), 0
                        }, j = {}.hasOwnProperty, D = [], q = D.pop, L = D.push, H = D.push, O = D.slice,
                        P = function (e, t) {
                ...
                E.fn.extend({
                    has: function (e) {
                        ...
                        if (!j.test(e)) for (; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && E.find.matchesSelector(n, e))) {
                            o.push(n);
                            break
                        }
                ...
                var re = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
                    ...
                    oe = ["Top", "Right", "Bottom", "Left"], ae = x.documentElement, se = function (e) {
                ...
                function Dt(e, t, n, r) {
                    ...
                    })); else if (n || "object" !== T(t)) r(e, t); else for (i in t) Dt(e + "[" + i + "]", t[i], n, r)
                }
                ...
                var qt = /%20/g, Lt = /#.*$/, Ht = /([?&])_=[^&]*/, Ot = /^(.*?):[ \t]*([^\r\n]*)$/gm,
                    Pt = /^(?:GET|HEAD)$/, Rt = /^\/\//, Mt = {}, It = {}, Wt = "*/".concat("*"),
